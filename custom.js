...
var myChart = new Chart(ctx, {
  ...
  data: {
    // Data Labels
    labels: ["India", "Londan", "Dubai", "Thailand", "Singapore", "Paris"],

    datasets: [
      // Data Set 1
      {
        //  Chart Label
        label: "famous tourist places ratio",

        // Actual Data
        data: [55, 77, 75, 22, 100, 25],
  ...
  options: {
    ...
    tooltips: {
      ...
      backgroundColor: "yellow", // Set Tooltip Background Color
